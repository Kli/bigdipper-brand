...
<!-- REQUIRED JS SCRIPTS -->
<script src="{{ admin_asset ("/vendor/laravel-admin/AdminLTE/plugins/chartjs/Chart.min.js?1.1.2") }}"></script>
...
<script src="{{ admin_asset ("/vendor/laravel-admin/AdminLTE/plugins/raphael/raphael.js") }}"></script>
{!! Admin::js() !!}
